...
const categoryAS = ["0", "36", "3600", "6000", "6001", "6002", "6003", "6004", "6005", "6006", "6007", "6008", "6009", "6010", "6011", "6012", "6013", "6014", "6015", "6016", "6017", "6018", "6020", "6021", "6023", "6024", "7001", "7002", "7003", "7004", "7005", "7006", "7009", "7011", "7012", "7013", "7014", "7015", "7016", "7017", "7018", "7019", "10000", "10001", "10002"]
...
context('Top Charts', () => {
    ...
    it('.type() - type into a DOM element', () => {
        ...
        for (var i = 0; i <= favcountryID.length - 1; i++) {
            ...
            for (var n = 0; n <= categoryAS.length - 1; n++) {
                let catID = categoryAS[n];
                cy.request({
                    method: 'get',
                ...
                /* if (catID == '3600' || catID == '0') {
                     ...
                     cy.request({
                         method: 'get',
                         followRedirect: true, log: true, //turn off
                         url: 'api/' + favcountryID[i] + '/top-charts/?device_type=' + deviceType + '&length=20&list_type=grossing&start=0&store_id=' + categoryAS[n] + '&timestamp=' + todaysDate,
                         headers: {
                             'accept': 'application/json'
                         },
                         response: []
